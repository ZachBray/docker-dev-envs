...
alias vim.ts-rc="$DOCKER_PREFIX env/vim/ts-rc"
alias vim.ts2="echo Use vim.ts instead"
alias vim.mono="$DOCKER_PREFIX env/vim/mono"
alias vim.rust="$DOCKER_PREFIX  -v ~/.cargo:/home/dev/.cargo env/vim/rust"
alias vim.rust-nightly="$DOCKER_PREFIX -v ~/.cargo:/home/dev/.cargo env/vim/rust-nightly"
alias vim.eclim="$DOCKER_PREFIX -v ~/.gradle:/home/dev/.gradle env/vim/eclim"
